...
const FinanceRoute: React.FC = () => {
    ...
    // Role check: Allow 'finance' AND 'admin'
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 p-4">
            ...
            <p className="text-gray-600 mb-6 text-center max-w-md">
                You do not have the required permissions to access the Finance Portal.
            </p>
            <a href="/" className="bg-emerald-600 text-white px-6 py-2 rounded-lg hover:bg-emerald-700 transition">
                Return Home
            </a>
        </div>
    );
